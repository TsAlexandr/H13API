...
export class PostsQueryRepository{
  ...
  async findAllPosts(userId:string|null, pageNumber:number ,pageSize:number, sortBy:string, sortDirection:any){
  ...
  async findPostById(id:string|null, userId:string){
    ...
    const post =  await this.postModel.aggregate([{$match:{_id: ID}},{
      $lookup: {
        from: "likes",
        localField: "_id",
        foreignField: "postId",
  ...
  async getPostsByBlogId(userId:string, blogId:string,pageNumber:number, pageSize:number,sortBy:string,sortDirection:any){
    ...
    const posts = await this.postModel.aggregate([{$match:{blogId:blogId}},{
      $lookup: {
        from: "likes",
        localField: "_id",
        foreignField: "postId",
    ...
    const totalCount:number = await this.postModel.count({blogId:new ObjectId(blogId)});
